// Program pads the string of characters to the left 
// Program inputs the pad_character at the start of the string
...
void pad_left(struct character_node *characters, char pad_character) {
    ...
    struct character_node *previous = NULL;
    char temp1;
    char temp2;
    ...
    while (current != NULL) {
        ...
        // For the first character in the list
        // Make first struct == pad_character
        if (previous == NULL) {
            temp1 = current->data;
            current->data = pad_character;
            previous = current;
        ...
        // If at the second last character
        if (current->next == NULL) {
            current->data = temp1;
            current = NULL;
        }
